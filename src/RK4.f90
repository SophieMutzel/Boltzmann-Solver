...
!  call rhs_region3a( u0 + dt * k3, params, argsint, t + dt, k4 )
  call region3a_log( params%N*nrhs, t, u0, k1, params, argsint )
  call region3a_log( params%N*nrhs, t + dt/2.0_rk, u0 + dt/2.0_rk* k1, k2, params, argsint )
  call region3a_log( params%N*nrhs, t + dt/2.0_rk, u0 + dt/2.0_rk* k2, k3, params, argsint )
  call region3a_log( params%N*nrhs, t + dt, u0 + dt * k3, k4, params, argsint )

subroutine region_freeze_out( N, lz, Y, Ynew, params, argsint )
  implicit none
  ...
  real(kind=rk), dimension(params%N)                :: Tp, sv_aaxx, sv_xxaa, neqz,neqaz
  real(kind=rk), dimension(params%N)                :: gam_xxff
...
Ynew = reshape(rhs,(/N/))
end subroutine region_freeze_out
